...
import com.mascova.talarion2.repository.PersistentTokenRepository;
...
public class AccountResource {
  ...
  public void invalidateSession(@PathVariable String series) throws UnsupportedEncodingException {
    ...
    userRepository.findOneByLogin(SecurityUtils.getCurrentUser().getUsername())
        .ifPresent(
            u -> {
  ...
  private boolean checkPasswordLength(String password) {
    return (!StringUtils.isEmpty(password) && password.length() >= UserDTO.PASSWORD_MIN_LENGTH && password
